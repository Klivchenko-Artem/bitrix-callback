...
class CallbackFormComponent extends CBitrixComponent implements Controllerable, Errorable
{
    ...
    public function submitAction(array $fields): ?array
    {
        ...
        try {
            ...
            //
            // В журнал не пишем: за общим адресом (офис, мобильный оператор)
            // блокировка одна на всех, и при всплеске это залило бы журнал
            // строкой на каждый запрос, утопив в них настоящие ошибки
            if (!$locked) {
